...
| `xorg-server-devel` | 21.1.22-2 |
| `xorg-server-src` | 21.1.22-2 |
| `xorg-server-xephyr` | 21.1.22-2 |
| `xorg-server-xnest` | 21.1.22-2 |
| `xorg-server-xvfb` | 21.1.22-2 |
...
| `xorg-xvinfo` | 1.1.5-2 |
| `xorg-xwayland` | 24.1.11-2 |
| `xorg-xwd` | 1.0.9-2 |
| `xorg-xwininfo` | 1.1.6-2 |
| `xorg-xwud` | 1.0.7-1 |
| `yt-dlp` | 2026.03.17-1 |
| `zathura` | 2026.05.11-1 |
| `zoxide` | 0.9.9-2 |
| `zsh` | 5.9-6 |
